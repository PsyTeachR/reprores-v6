...
* The countries in the two data sets aren't always written exactly the same. This is a very common problem with many solutions. You will need to fix it and not just omit data when the same country name is written in two different ways.
* You will also need to combine yarn shops for the UK, Scotland, England, Wales and Northern Ireland, and include them all as "United Kingdom".
