...
You can install the newest version of reprores from [GitHub](https://github.com/psyteachr/reprores-v6) with:

``` r
devtools::install_github("psyteachr/reprores-v6")
```
...
Lisa DeBruine & Dale Barr. (2022). Data Skills for Reproducible Research (4.0) Zenodo. doi:10.5281/zenodo.6527194
