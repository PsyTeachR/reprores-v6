...
Download the [Data transformation cheatsheet](https://rstudio.github.io/cheatsheets/html/data-transformation.html).
...
```{r}
#| label: tbl-demo-customers
#| echo: false
#| tbl-cap: Demo customers table
customers
```
...
```{r}
#| label: tbl-demo-orders
#| echo: false
#| tbl-cap: Demo orders table.
...
::: {.join}
<img src="images/joins/left_join.png" alt="title: left_join(x, y), image: two circles in a venn diagram, with the left circle labelled x and the right circle labelled y; the entire left circle is shaded pink." />
:::
...
::: {.join}
<img src="images/joins/left_join_rev.png" alt="title: left_join(y, x), image: two circles in a venn diagram, with the left circle labelled x and the right circle labelled y; the entire right circle is shaded pink." />
:::
...
::: {.join}
<img src="images/joins/right_join.png" alt="title: right_join(x, y), image: two circles in a venn diagram, with the left circle labelled x and the right circle labelled y; the entire right circle is shaded orange" />
:::
...
::: {.join}
<img src="images/joins/inner_join.png" alt="title: inner_join(x, y), image: two circles in a venn diagram, with the left circle labelled x and the right circle labelled y; only the overlapping part is shaded yellow"/>
:::
...
::: {.join}
<img src="images/joins/full_join.png" alt="title: full_join(x, y), image: two circles in a venn diagram, with the left circle labelled x and the right circle labelled y; both circles are shaded green." />
:::
...
::: {.join}
<img src="images/joins/semi_join.png" alt="title: semi_join(x, y), image: two circles in a venn diagram, with the left circle labelled x and the right circle labelled y; only the overlapping part is shaded blue and the label for y is greyed out. A caption below reads 'only columns from x, no duplicate rows, even if >1 match in y'"/>
:::
...
::: {.join}
<img src="images/joins/semi_join_rev.png"  alt="title: semi_join(y, x), image: two circles in a venn diagram, with the left circle labelled x and the right circle labelled y; only the overlapping part is shaded blue and the label for x is greyed out. A caption below reads 'only columns from y, no duplicate rows, even if >1 match in x'"/>
:::
...
::: {.join}
<img src="images/joins/anti_join.png" alt="title: anti_join(x, y), image: two circles in a venn diagram, with the left circle labelled x and the right circle labelled y; only the non-overlapping part of x is shaded purple"/>
:::
...
::: {.join}
<img src="images/joins/anti_join_rev.png"   alt="title: anti_join(y, x), image: two circles in a venn diagram, with the left circle labelled x and the right circle labelled y; only the non-overlapping part of y is shaded purple"/>
:::
