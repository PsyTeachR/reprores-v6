...
You can join <a href="https://psyteachr.github.io/reprores-v6/data/scottish_population.csv" download>Scottish population data</a> to the map table to visualise data on the map using colours or labels.
